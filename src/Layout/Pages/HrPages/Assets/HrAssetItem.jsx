    ...
    return (
        <div className="text-[#a8a7a7] font-raleway w-full border rounded-sm px-2 border-[#ffffff10] py-4">
            ...
            <div className="space-x-4 w-full flex mt-5">
                <button className="px-5 text-sm py-[6px] rounded-sm border border-[#ffffff1f]">update</button>
                <button className="px-5 text-sm py-[6px] rounded-sm border border-[#ffffff1f]">delete</button>
            </div>
        </div>
    );
};
