...
const Items = ({name, category, reqDate }) => {
    return (
        <div className="text-[#a8a7a7] font-raleway border-b border-[#ffffff10] py-4">
            ...
            <span className="text-xs font-raleway border border-[#ffffff1f] font-light rounded-xl px-2 py-[2px]">requested date : {reqDate}</span>
        </div>
    );
};
